...
import { InventoryChart } from '../../@core/data/inventory-chart';
import { InventoryChartService } from '../../@core/data/inventory-chart.service';
import { LayoutService } from '../../@core/utils/layout.service';


@Component({
    selector: 'ngx-inventory-chart',
...
export class InventoryChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  @Input()
  ...
  ngOnChanges(): void {
    if (this.option) {
      this.updateOrdersChartOptions(this.inventoryChartData);
    }
  }

  constructor(private theme: NbThemeService,
              private layoutService: LayoutService,private inventoryChartService: InventoryChartService) {
    this.getOrdersChartData("week").then(x=>
      {
